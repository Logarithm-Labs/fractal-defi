...
class RSIStrategy(BaseStrategy):
    ...
    def predict(self) -> ActionToTake:
        ...
        # Check conditions for opening a position
        if not self.rsi_strategy_state.in_position:
            # VARIANT 1: Original conditions
            # 1. RSI < 30 (oversold)
            # 2. Close price > SMA(10) (moving average breakout)
            # 3. Close price > Open price (green candle)
            
            # VARIANT 2: Relaxed conditions (comment variant 1 and uncomment variant 2)
            # 1. RSI < 30 (oversold)
            # 2. Either close price > SMA(10) or green candle

            # Uncomment one of the variants below:
            
            # Variant 1 (original conditions - all must be met)
            """
            ...
            # Variant 2 (relaxed conditions - RSI + any other condition)
            if (current_rsi < self._params.RSI_OVERSOLD and 
        ...
        # Check conditions for closing a position
        else:
            ...
            # RSI overbought (signal exit variant)
            ...
            # Price fell below SMA (signal exit variant)
